...
if __name__ == '__main__':
    ...
    player_name = input("Insira o nome do Jogador 1 da Dupla 1\n")
    player1 = Player(player_name)
    
    player_name = input("Insira o nome do Jogador 2 da Dupla 1\n")
    player2 = Player(player_name)

    player_name = input("Insira o nome do Jogador 1 da Dupla 2\n")
    player3 = Player(player_name)

    player_name = input("Insira o nome do Jogador 2 da Dupla 2\n")
